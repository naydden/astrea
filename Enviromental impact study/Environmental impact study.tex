...
\author{}
\title{Environmental Impact Study}
...
\paragraph{}
This document pretends to assess the environmental consequences (positive and negative) of developing the project. The target of this study is to identify, predict, evaluate and mitigate the biophysical and social negative effects that the project could generate during the execution of it.


\chapter{Ground Stations}
\paragraph{}
At first sight the Ground Stations do not represent any environmental problem. The main factor that has to be taken in account is the placement of the stations. They have to be located in a place where they does not interfere with the ecosystem. The placement of the stations has to be adequate with the environmental legislation of the countries. 
...
\paragraph{}
During the orbital performance of the satellites, it has to be taken in account that if them would be orbital waste. The satellites are designer to burn out in the atmosphere at the end of their useful life. This burnt should not leave any solid residue that could precipice over the surface. The deorbit would be forced and controlled by the propulsion system of the satellite. In the case that this system fail, given that the will orbit in a LEO, they will be deorbited and burnt out naturally  
in a period around 5 years.

\chapter{Launch system}
\paragraph{}
...
\paragraph{} The document also evaluates the following possible risks:
\begin{itemize}
