...
\subsubsubsection*{Propulsion System}
\begin{longtable}{| l | r |}
...
Payload communication capabilities. Depending onthe Bandwidth selected a Sensitivity, S, is imposed by \ref{SvsB}. Then with this fixed power is possible to obtain the range of communication from Figure\ref{friis}.
\begin{figure}[H]
...
\end{figure}
\clearpage
\section{Subsystems conceptual relations}
%IMPORTANT
%si es vol que quedi la pagina recte i només la imatge girada al PDF cal cambiar el package \usepackage{pdflscape} per \usepackage{lscape}
\begin{landscape}
	\begin{figure}[h]
		\centering
...
\end{landscape}
\clearpage
%\includepdf[pagecommand={\thispagestyle{headers}}]{./sections/SatelliteConfiguration/ESQUEMA_ASTREASAT}
%\includepdf[pagecommand={\thispagestyle{headers}}]{./sections/SatelliteConfiguration/Payload_detail}