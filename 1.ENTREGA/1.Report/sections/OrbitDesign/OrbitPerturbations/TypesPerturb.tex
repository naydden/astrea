...
\begin{itemize}
\item Gravity Field of the Central Body: due to the Earth's aspherical shape as seen in [REF TO ANNEX I.Section 4.1.2]. This perturbation will not be considered because it does not affect Astrea's constellations as shown in [REF TO ANNEX I.Section 4.3.1]
\item Atmospheric Drag: It is the perturbation caused by the remaining atmosphere. The study of the satellites orbit decay can be found in [REF TO ANNEX I.Section 4.3.3]. Even so, this effect is not taken into account because the satellites are equipped with thrusters.
\item Third Body perturbations: Perturbation computed in [REF TO ANNEX I.Section 4.1.4]
\item Solar-Radiation Pressure: Explained in [REF TO ANNEX I.Section 4.3.2]
