...
\begin{table}[]
\centering
\caption[Orbit Decay Analysis]{Selected data to compute orbit decay extracted from figure \ref{figure4}}
\label{OrbDecCompT}
\begin{tabular}{|l|c|}
\hline
...
\begin{figure}[H] %[b] % h / H / b / t
	...
	\caption[Orbit Decay computed 2]{Orbit Decay computed for several values of }
