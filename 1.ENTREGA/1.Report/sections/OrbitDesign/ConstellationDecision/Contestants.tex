...
In this chapter it is seen how the final constellation configuration is decided. To do that an ordered weighted average analysis will be performed.
...
\subsubsubsection*{Candidates 3 and 4: Walker-Delta GS Coverage}
...
\subsubsubsection*{Candidate 6: Walker-Delta J2 + Rotation}
...
\begin{figure}[H]%[H] %[b] % h / H / b / t
	...
	\caption[Candidate 7]{Candidate 7. Full Walker-Delta constellation configuration.h= 542km; in=72; Np=9; Npp=21; Tsat= 189}
	\label{fig:Candidate7}
\end{figure}

\subsubsubsection*{Candidate constellations parameters}
