...
Currently, there isn't any mission involving a large number of satellites implementing inter-satellite connection. However, missions like \textbf{QB-50} and \textbf{Kepler} are going to use this technology. The objective of these missions and other small satellites related projects is exposed at the Table 1
% \ref{currentsats}
...
\textit{Astro Digital} & 20 & 2015 & Earth Observation\\& & &(Landmapper-HD). \\ \hline
...
\textit{Kepler} & 50 & 2017 & Coordinate and relay the  communication between satellites and ground. \\ \hline
\end{tabular}
\caption[Current and future small satellites missions]{Current and future small satellites missions. Adapted from \cite{nanosats, ISC}}
\end{table}