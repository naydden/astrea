...
After comparing the TC and Proximity-1 Protocols (more information at Annex II 7.1.2), the decision taken is to use the TC Space Data Link Protocol with the TC sync and channel coding together with the Space Data Link Security Protocol. The reasons for doing so are mainly:
\begin{itemize}
