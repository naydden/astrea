...
In order to calculate the initial investment in order to build the entire Ground Segment, another economical study must be done. Same as the previous studies, this one can also be found in Attachment XXXXX. The results of said study will be exposed in the following lines:
