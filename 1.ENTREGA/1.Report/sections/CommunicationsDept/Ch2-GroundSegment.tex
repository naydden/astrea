...
In the following lines the characteristics of the different available protocols for the application layer depending on the presentation of the data is presented.
\section{Ground Segment protocols}

\subsection{File Transfer Protocol (FTP)} 
The File Transfer Protocol (FTP) is used to transfer computer files between a client and server on a computer network.
