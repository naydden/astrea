...
It is also mandatory to refer that this graph represents the absorption for a satellite in the zenith, in other words, for an elevation angle of 90 degrees. For lower angles, the atmospheric absorption ($L_{abs}$) is given by \cite{Jorge2012}:
%\begin{equation}
...
\paragraph{} Applying equation \ref{channelCapacity} and equation \ref{noise} on a simple Matlab routine:
