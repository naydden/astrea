...
The results are computed for a 3U CubeSat with an ion thruster. The characteristics of the thruster are the following ones (for more characteristics of the thruster refer to the section ~\ref{ch:PS}.):
