...
Rocket Lab provides two Gantt diagrams which are included at  \cite[Chapter 1, Section 2]{annex2} on which their launching procedure is explained.
%
%\begin{figure}{}
%    \centering
...
Planes are going to be placed consecutively from the first one to the last one. This way allows a growing wider range of communication during the time the constellation is being set up. The whole discussion on which would be the best way to set up the orbital planes on the first placement can be found in \cite[Chapter 1, Section 2]{annex2}.