...
quality_time=zeros(1,length(t));
%If a flyby lasts longer than 3 minutes, 
% then the previous 3 minutes were successfuly covered.

time_record=zeros(1,N);     % Accumulates Timesteps being on the GS
before_tracking=zeros(1,N); 
% Boolean to know which ones are already passing by
...
legend('Length of flybys','Links by end of flyby',...
    'Num of sats @flybys longer than 3 min')
xlabel('Time (h)')
